...
public enum Units {
    ...
    FOOT_SOLDIER(R.drawable.foot_soldier, UnitsOptions.CIRCLE_OPTIONS, R.color.magenta, R.color.red, 15),
    MARAUDER(R.drawable.marauder, UnitsOptions.CIRCLE_OPTIONS.radius(60), R.color.cyan, R.color.red, 25),
    ...
    MEDIC(R.drawable.medic, UnitsOptions.CIRCLE_OPTIONS, R.color.medicPink, R.color.red, 30);
