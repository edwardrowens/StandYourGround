 ...
 *
 */
public class OnUnitClickListenerFactory {

    private static final Logger logger = new Logger(OnUnitClickListenerFactory.class);
    ...
    @Inject
    OnUnitClickListenerFactory(Lazy<GoogleMapProvider> googleMapProvider,
